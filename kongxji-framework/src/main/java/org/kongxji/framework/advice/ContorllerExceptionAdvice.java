package org.kongxji.framework.advice;


import org.kongxji.framework.bean.Response;
import org.kongxji.framework.security.TokenException;
...
/**
 * 全局的异常处理(对Controller层产生的异常进行处理)
 * @author lh
 * @since 1.0.0
 */
@RestControllerAdvice
public class ContorllerExceptionAdvice {
    private static Logger logger = LoggerFactory.getLogger(ContorllerExceptionAdvice.class);
